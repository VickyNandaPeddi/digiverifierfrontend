...
export class UanConfirmationComponent implements OnInit {
  ...
  constructor(private router: ActivatedRoute, private navRouter: Router, private candidateService: CandidateService ,private customers:CustomerService) {
